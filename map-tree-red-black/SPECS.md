...
Purpose
- [ ] Create empty ordered map with red-black-backed key ordering.
...
- [ ] Red-black invariants remain valid after operation.
...
- [ ] Delete root and black-sibling fix-up scenarios work correctly.
- [ ] Comparator order and red-black invariants remain valid after deletion.
...
- [ ] `Clone()` and `CloneWith(...)` preserve `Len()`, comparator, ascending key order, and red-black invariants in clone.
...
- [ ] Suggested safety factor for stable simple red-black-map ops is `1.75x`.
